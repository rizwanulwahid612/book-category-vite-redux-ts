...
import { useDeleteBookMutation, useGetReviewQuery, useGetUsersQuery, usePostReviewMutation, useSingleBookQuery } from "../redux/features/books/booksApi"
...
console.log(isSuccess)
 const [deleteBook] = useDeleteBookMutation(book?._id)
